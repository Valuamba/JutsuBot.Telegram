...
//        {
//            var branchBuilder = new BotPipelineBuilder<TContext>(Logger, ServiceCollection);
...
//        public IBotPipelineBuilder<TContext> UseUnorderedHandlerCommand<THandler>(
//            Predicate<TContext> predicate)
//            where THandler : IUpdateHandler<TContext>
//        {
//            return MapWhen(
//                     ctx => predicate(ctx),
//                     botBuilder => botBuilder.Use<THandler>()
//                 );
//        }
