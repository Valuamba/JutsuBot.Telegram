...
namespace CliverBot.Console.Form.Elements.Select
{
        ...
        where TModel : new()
    {
        ...
        public abstract List<List<InlineKeyboardButton>> GetInlineButtons(TContext context, int page);
        //{
        ...
        public abstract Task NotifyStep(TContext context, CancellationToken cancellationToken);
        //{
        //    int page = 1;
